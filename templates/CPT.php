    ...
    <div class="tab-content">
        ...
        <div id="tab-1" class="tab-pane <?php echo ( ! isset($_POST['edit_post']) ? 'active' : '' ); ?>">
            ...
            <?php
                ...
                // $options = ( ! get_option( 'niloy_plugin_cpt' ) ) ? array(): get_option('niloy_plugin_cpt');
				...
				foreach ($options as $option) {
					$public = isset($option['public']) ? '<span class="dashicons dashicons-thumbs-up"></span>' : '<span class="dashicons dashicons-thumbs-down"></span>';
					$archive = isset($option['has_archive']) ? '<span class="dashicons dashicons-thumbs-up"></span>' : '<span class="dashicons dashicons-thumbs-down"></span>';
					...
					settings_fields( 'niloy_plugin_cpt_settings' );
        ...
        <div id="tab-2" class="tab-pane<?php echo ( isset($_POST['edit_post']) ? ' active' : '' ); ?>">
            ...
            <form action="options.php" method="post">
                ...
                <?php
                    ...
                    settings_fields( 'niloy_plugin_cpt_settings' );
                    do_settings_sections( 'niloy_CPT' );
                    submit_button();
